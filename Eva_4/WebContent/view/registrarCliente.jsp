...
<body>
	...
	<form action="../AdminCliente?action=mostrarPorRut" method="POST">
		<table>
			<tr>
	...
	<br>
	<div><a href="${pageContext.request.contextPath}/AdminCliente?action=crear">Crear Cliente</a></div>
	<div><a href="${pageContext.request.contextPath}/AdminCliente?action=mostrarPorRut">Buscar Cliente por RUT</a></div>
